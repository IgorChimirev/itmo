...
/*
 * Класс, представляющий местоположение "до" с координатами x, y, z и именем.
 */
public class LocationTo {
    ...
    /*
     * Конструктор, создающий объект LocationTo с заданными значениями x, y, z и именем.
     *
     ...
     */
    public LocationTo(double x, double y, int z, String name) {
        this.x = x;
        this.y = y;
        this.z = z;
        this.name = name;
    ...
    public boolean equals(Object object) {
        ...
        LocationTo that = (LocationTo) object;
