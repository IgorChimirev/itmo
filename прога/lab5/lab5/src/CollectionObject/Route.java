...
public class Route {
    ...
    private double distance; // Значение должно быть больше 0.
     ...
     */
    public Route(Long id, String name, Coordinates coordinates, Date creationDate, LocationFrom from, LocationTo to, double distance) {
        this.id = id;
        this.name = name;
