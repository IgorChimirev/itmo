...
public class April extends Entity implements IHuman {
    ...
    public void DrivingSomewhere(Entity first, Entity second) {
        ...
        System.out.println(getConditionAdjective(second) + " " + second.getName() + " и " + getConditionAdjective(first)
                + first.getName() + "смогли найти новое платье " + second.getWeight() + " " + first.getWeight() + ".");
    ...
    public void Eat(Entity first, Entity second) {
        ...
        System.out.println(
                first.getName() + "и" + second.getName() + "отравились  и теперь их  вес составляет " + this.getWeight()
                        + "и" + second.getWeight() + ". Теперь они отправились в " + second.getLocation() + ".");
    }
    ...
    public void HorseWalk(Entity first, Entity second) {
        ...
        System.out.println(
                this.getName() + " поехал в конюшню вместе с " + second.getName() + ",чтобы покататься на лошадях.");
    ...
    public void Dreaming(Entity first) {
        ...
        this.setLocation(PlaceConstans.STABLE);
