...
public abstract class Entity {
    ...
    public String getInfo() {
        return "Имя: " + name + ", Вес: " + weight + ", Состояние: " + condition + ", HP: " + hp + ", Локация: "
                + location + ", Телефон: " + phone;
    }
            ...
            switch (this.getCondition()) {
                case NOTHUNGER:
                    ...
                    System.out.println(this.getName()
                            + " смог дозвониться и попросить прислугу принести ему еды, теперь его вес " + getWeight());
                case WOUNDED:
                    this.setLocation(PlaceConstans.HOSPITAL);
                    System.out.println(this.getName() + " смог дозвониться и вызвал себе скорую, теперь он находится в "
                            + this.getLocation());
