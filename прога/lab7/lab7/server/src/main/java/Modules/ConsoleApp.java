...
public class ConsoleApp {
    ...
    public ConsoleApp(Command help, Command info, Command show, Command add, Command update, Command removeById,
                      ...
                      Command filterStartsWithName,Command removeKey,Command ClearAllCommand, Command replaceIfLower, Command RandomCommand,Command FilterCommand,Command ShowUserElementsCommand) {
        this.help = help;
        this.info = info;
        this.show = show;
        this.add = add;
    ...
    public void filterStartsWithName(User user,String arguments, RouteModel objectArg) {
        filterStartsWithName.execute(user,arguments, objectArg);
    }
